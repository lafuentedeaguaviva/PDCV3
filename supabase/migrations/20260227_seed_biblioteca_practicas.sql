...
INSERT INTO biblioteca_practicas 
    (proposito, tipo, nombre_practica, descripcion_concreta, apto_para, redactado, preguntas, ejemplo_inicial, ejemplo_primaria, ejemplo_secundaria, ejemplo_multigrado)
VALUES
...
(
    ...
    'Todos', '', '¿Qué sabemos del tema? ¿Qué nos gustaría aprender? ¿Qué creemos que es verdad?',
...
(
    ...
    'Todos', '', '¿Qué observas en estas imágenes? ¿Qué historia cuentan? ¿Qué relación tienen con nuestra vida?',
...
(
    ...
    'Todos', '', '¿Qué sensaciones tuviste? ¿Qué predices? ¿Cómo llegaste a esa conclusión?',
...
(
    ...
    'Todos', '', '¿Con cuál afirmación estás más de acuerdo? ¿Qué te sorprendió de las respuestas de tus compañeros?',
...
(
    ...
    'Todos', '', '¿Cuál es el problema central? ¿Qué lo causó? ¿Qué harías tú en esa situación?',
...
(
    ...
    'Todos', '', '¿Qué observaste? ¿Qué cambió? ¿Qué conclusión puedes sacar de lo que viste?',
...
(
    ...
    'Todos', '', '¿Qué fuentes consultaste? ¿Cómo sabés que la información es confiable? ¿Qué descubriste de nuevo?',
...
(
    ...
    'Se divide el tema en partes. Cada grupo se convierte em experto de una parte y luego enseña a los demás. Promueve la interdependencia positiva y el aprendizaje activo.',
    'Todos', '', '¿Qué aprendiste de tu grupo? ¿Qué te resultó más difícil de explicar? ¿Qué añadirías?',
...
(
    ...
    'Todos', '', '¿Cómo llegaste a esa respuesta? ¿Podrías resolverlo de otra manera? ¿Qué pasaría si...?',
...
(
    ...
    'Todos', '', '¿Qué quisiste comunicar? ¿A quién va dirigido tu texto? ¿Qué cambiarías si pudieras?',
...
(
    ...
    'Todos', '', '¿Qué parte fue más difícil de construir? ¿Qué representa cada parte del modelo? ¿Qué mejorarías?',
...
(
    ...
    'Todos', '', '¿Cómo te sentiste en ese rol? ¿Qué aprendiste de los otros roles? ¿Fue realista la simulación?',
...
(
    ...
    'Todos', '', '¿A quién beneficia tu proyecto? ¿Qué conocimientos usaste de otras materias? ¿Qué impacto tendría?',
...
(
    ...
    'Todos', '', '¿Qué aprendiste de tu comunidad? ¿Cómo puedes aportar a mejorarla? ¿Qué valores encontraste?',
...
(
    ...
    'Todos', '', '¿Qué fue lo más difícil? ¿Qué estrategia te funcionó mejor? ¿Qué necesitas repasar?',
...
(
    ...
    'Todos', '', '¿Cómo cambió lo que pensabas antes con lo que sabes ahora? ¿Para qué te sirve en tu vida?',
...
(
    ...
    'Todos', '', '¿Qué te llevas de hoy? ¿Qué te gustaría investigar más? ¿Cómo conecta esto con tu vida?',
